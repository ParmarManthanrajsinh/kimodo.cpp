...
public:
    ...
    static HttpResult apiGet(const std::string& path, const std::string& token,
                             std::string& error);
    ...
    static bool download(const std::string& url, const std::string& tmpPath,
                         const std::string& token, ProgressFn progress,
                         std::string& error, int retries = 3);

    static std::string resolveUrl(const std::string& repo, const std::string& remotePath);
};
